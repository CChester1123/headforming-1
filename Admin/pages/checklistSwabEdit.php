<title>Swab Assembly Edit</title>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="row">
                                                ...
                                                <div class="col-sm"><br>
                                                    <input type="text" id="pulltestingSample1" class="form-control actualDataLoop result" placeholder="Enter Sample 1" value="<?php echo htmlspecialchars($user->value1actual($row['pulltestingSample'])); ?>">
                                                </div>

                                                <div class="col-sm"><br>
                                                    <input type="text" id="pulltestingSample2" class="form-control actualDataLoop result" placeholder="Enter Sample 2" value="<?php echo htmlspecialchars($user->value2actual($row['pulltestingSample'])); ?>">
                                                </div>

                                                <div class="col-sm"><br>
                                                    <input type="text" id="pulltestingSample3" class="form-control actualDataLoop result" placeholder="Enter Sample 3" value="<?php echo htmlspecialchars($user->value3actual($row['pulltestingSample'])); ?>">
                                                </div>

                                                <div class="col-sm"><br>
                                                    <input type="text" id="pulltestingSample4" class="form-control actualDataLoop result" placeholder="Enter Sample 4" value="<?php echo htmlspecialchars($user->value4actual($row['pulltestingSample'])); ?>">
                                                </div>

                                                <div class="col-sm"><br>
                                                    <input type="text" id="pulltestingSample5" class="form-control actualDataLoop result" placeholder="Enter Sample 5" value="<?php echo htmlspecialchars($user->value5actual($row['pulltestingSample'])); ?>">
                                                </div>
                                                ...
                                                <script>
                                                    ...
                                                    if (remarksPullTestingValue.toLowerCase() === 'passed') {
                                                        ...
                                                        inputElementRemarksPullTesting.style.color = 'white';
                                                        inputElementRemarksPullTesting.style.fontWeight = 'bold';
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm"><br>
                                                <input type="text" id="enterNA" class="form-control actualDataLoop result" placeholder="Enter (N/A)" value="<?php echo $row['enterNA']; ?>">
                                            </div>
