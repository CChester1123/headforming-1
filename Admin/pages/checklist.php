...
<script>
  ...
  function filterPartNo() {
    ...
    // Get all options in the FG PART NO. dropdown
    const partNoOptions = document.querySelectorAll("#partNo option");

    // Loop through all options and show/hide based on the selected department
    ...
    // Reset the selected value of the FG PART NO. dropdown
