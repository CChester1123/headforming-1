                    ...
                    <div class="col-sm">
                      ...
                      <select class="form-control" id="acknowledge" data-placeholder="Acknowledge By" style="width: 100%;" readonly>
                        ...
                        while ($list = mysqli_fetch_array($sql)) { ?>
                          <option value="<?php echo $list['employeeID']; ?>" <?php if ($list['employeeID'] == $row['acknowledge']) {
                                                                                echo "selected";
                    ...
                    <div class="col-sm">
                      ...
                      <select class="form-control" id="maintenancecheced" data-placeholder="Maintenance By" style="width: 100%;" readonly>
                        ...
                        while ($list1 = mysqli_fetch_array($sql)) { ?>
                          <option value="<?php echo $list1['employeeID']; ?>" <?php if ($list1['employeeID'] == $row['maintenancecheced']) {
                                                                                echo "selected";
                                                                              } ?>> <?php echo $list1['fullName']; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm">
                      ...
                      <select class="form-control" id="operation" disabled>
                        <option value="Single" <?php if ($row['operation'] == "Single") {
                                                  echo "selected";
                                                } ?>>Single</option>
                        <option value="Dual" <?php if ($row['operation'] == "Dual") {
                                                echo "selected";
                                              } ?>>Dual</option>
                      </select>
                    </div>
                ...
                <?php if ($row['type'] == "Start-up qualification") { ?>
                  ...
                  <!--       <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input type="checkbox" id="maintenance" name="maintenance" value="checked" <?php if ($row['maintenance'] == "checked") {
                                                                                                          echo "checked";
                                                                                                        }  ?>  readonly>
                        </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation(
                                                                          $user->value1Actual($row['arrcuttingspeed']),
                                                                          $user->value2Actual($row['arrcuttingspeed']),
                                                                          $user->value3Actual($row['arrcuttingspeed'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation(
                                                                          $user->value1Actual($row['arrapproachingposition']),
                                                                          $user->value2Actual($row['arrapproachingposition']),
                                                                          $user->value3Actual($row['arrapproachingposition'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation(
                                                                          $user->value1Actual($row['arrsealingpositionspeed']),
                                                                          $user->value2Actual($row['arrsealingpositionspeed']),
                                                                          $user->value3Actual($row['arrsealingpositionspeed'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation(
                                                                          $user->value1Actual($row['arrsealingposition']),
                                                                          $user->value2Actual($row['arrsealingposition']),
                                                                          $user->value3Actual($row['arrsealingposition'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <input type="text" class="form-control Position1" id="Mode" placeholder="Enter Minimum" value="<?php if ($user->value1Actual($row['arrMode']) == "Position") {
                                                                                                                                  echo $user->value1Actual($row['arrMode']);
                                                                                                                                } ?>" disabled>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <div id="remarks1"  style="margin-top:8px"><?php echo $user->checkValidationCheck(
                                                                              $user->value1Actual($row['arrMode']),
                                                                              $user->value2Actual($row['arrMode']),
                                                                              $user->value3Actual($row['arrMode'])
                                                                            ); ?></div>                                 
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <div id="remarks1"  style="margin-top:8px"><?php echo $user->checkValidation(
                                                                              $user->value1Actual($row['arrwatertemp']),
                                                                              $user->value2Actual($row['arrwatertemp']),
                                                                              $user->value3Actual($row['arrwatertemp'])
                                                                            ); ?></div>
                              </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <div id="remarks1"  style="margin-top:8px"><?php echo $user->checkValidation(
                                                                              $user->value1Actual($row['arrairpressure']),
                                                                              $user->value2Actual($row['arrairpressure']),
                                                                              $user->value3Actual($row['arrairpressure'])
                                                                            ); ?></div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <div id="remarks1"  style="margin-top:8px"><?php echo $user->checkValidation(
                                                                              $user->value1Actual($row['arrupperheatertemp']),
                                                                              $user->value2Actual($row['arrupperheatertemp']),
                                                                              $user->value3Actual($row['arrupperheatertemp'])
                                                                            ); ?></div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                  <div id="remarks1"  style="margin-top:8px"><?php echo $user->checkValidation(
                                                                                $user->value1Actual($row['arrlowerheatertemp']),
                                                                                $user->value2Actual($row['arrlowerheatertemp']),
                                                                                $user->value3Actual($row['arrlowerheatertemp'])
                                                                              ); ?></div>                               
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation(
                                                                          $user->value1Actual($row['arrlowermoldtemp']),
                                                                          $user->value2Actual($row['arrlowermoldtemp']),
                                                                          $user->value3Actual($row['arrlowermoldtemp'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrtotalLength']),
                                                                            ...
                                                                            $user->value7Actual($row['arrtotalLength'])
                                                                          ); ?></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrswabheadlength']),
                                                                            ...
                                                                            $user->value7Actual($row['arrswabheadlength'])
                                                                          ); ?></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrswabheadwidth']),
                                                                            ...
                                                                            $user->value7Actual($row['arrswabheadwidth'])
                                                                          ); ?></div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrswabheadthickness']),
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrswabhandlewidth']),
                        ...
                        <div class="col-sm">
                          <div class="container">
                            <div class="row">
                              <div class="col-sm">
                                <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                            $user->value1Actual($row['arrswabhandlediameter']),
                    ...
                    <div class="col-sm">
                      <div class="container">
                        <div class="row">
                          <div class="col-sm">
                            <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                        $user->value1Actual($row['substrateDimention']),
                                                                        ...
                                                                        $user->value7Actual($row['substrateDimention'])
                                                                      ); ?></div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="row">
                            <div class="col-sm">
                              <div id="remarks1" style="margin-top:8px"><?php echo $user->checkValidation2(
                                                                          ...
                                                                          $user->value7Actual($row['pullSeatTest'])
                                                                        ); ?></div>
                            </div>
                          </div>
                        </div>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <?php }
                if ($row['type'] == "Start-up qualification") {     ?>
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <input type="radio" id="option2" name="options" value="Passed" disabled <?php if ($row['selectedoption'] == "Passed") {
                                                                                                echo "checked";
                                                                                              } ?>> Passed
                    </div>
                    <div class="col-sm">
                      <input type="radio" id="option2" name="options" value="Failed" disabled <?php if ($row['selectedoption'] == "Failed") {
                                                                                                echo "checked";
                                                                                              } ?>> Failed
                    </div>
                  </div>
