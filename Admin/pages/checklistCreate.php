                    ...
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <input type="text" class="form-control Position-value" id="Mode" placeholder="Enter Minimum" value="<?php if ($user->value1Actual($row['mode']) == "Position") {
                                                                                                                                        echo $user->value1Actual($row['mode']);
                                                                                                                                      } ?>" disabled>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                 <input type="text" class="form-control Position-value" id="Mode" placeholder="Enter Maximum"  value="<?php if ($user->value2Actual($row['mode']) == "Pressure") {
                                                                                                                                        echo $user->value2Actual($row['mode']);
                                                                                                                                      } ?>" disabled>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm">
                        <div class="container">
                          <div class="row">
                            <div class="col-sm">
                              <!-- <center> <label> <?php //echo $row['pulltestdesc'];
                                                    ?></label></center> -->
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm">
                            <div class="container">
                              <div class="row">
                                <div class="col-sm">
                                  <input type="text" class="form-control actualDataLoop" id="actualDataLoop" <?php if ($i > 5) {
                                                                                                                echo "value='||'";
                                                                                                                echo "hidden";
