...
class admin_creation
{
    ...
    `swabdimensionspecsRange`, 
    `pull/sealstrengthspecsRange`, 
    `noofsample`, 
    `pullTest`, 
    `pulltestingMin`, 
    ...
    `pulltestdesc`, 
    `heaterTempUpnLowRange`, 
    `heatingTimeRange`, 
    `heaterSwabHandleFixtureRange`, 
    `fixtureClosingTimeRange`, 
    `department`
) 
VALUES (
    '$product', 
...
");
	...
	public function editProduct($prod_id, $product, $productDesc, $handle, $subtrate, $pulltestdesc, $status, $arrcuttingforce, $arrsealingtime, $arrcuttingspeed, $arrapproachingposition, $arrsealingpositionspeed, $arrsealingposition, $arruppermoldtemp, $arrlowermoldtemp, $arrtotalLength, $arrswabheadlength, $arrswabheadwidth, $arrswabheadthickness, $arrswabhandlewidth, $arrswabhandlethickness, $arrswabhandlediameter, $arrpulltest, $arrswabheadpulling, $arrswabheadpopping, $substrateDimensionforce, $pullSeatTestforce, $pulltestingMin, $noHandleperHT, $handleColor, $substrateLotNum, $handleTreeMaterialNum, $machineTreeMatType, $substrateType, $arrCheckbox, $moldopenspeed, $arrwatertemp, $arrairpressure, $arrupperheatertemp, $arrlowerheatertemp, $arrheaterTempUpnLow, $arrheaterSwabHandleFixture, $arrfixtureClosingTime, $department, $arrheatingTime)
	{
		...
		$result = mysqli_query($this->dbh, "UPDATE `headforming`.`tbl_products2`
SET
    `productname` = '$product',
    ...
    `handle` = '$handle',
    `substrate` = '$subtrate',
    `handleTreeColor` = '$handleColor',
    `substrateMatLotNum` = '$substrateLotNum',
    `handleTreeMatLotNum` = '$handleTreeMaterialNum',
    `handleTreeMatType` = '$machineTreeMatType',
    `substrateMatType` = '$substrateType',
    `cuttingforceRange` = '$arrcuttingforce',
    `sealingtimeRange` = '$arrsealingtime',
    `cuttingspeedRange` = '$arrcuttingspeed',
    `approachingpositionRange` = '$arrapproachingposition',
    `sealingpositionspeedRange` = '$arrsealingpositionspeed',
    `sealingpositionRange` = '$arrsealingposition',
    `mode` = '$arrCheckbox',
    `moldopenspeedRange` = '$moldopenspeed',
    `watertempRange` = '$arrwatertemp',
    `airpressureRange` = '$arrairpressure',
    `upperheattempRange` = '$arrupperheatertemp',
    `lowerheattempRange` = '$arrlowerheatertemp',
    `uppermoldtempRange` = '$arruppermoldtemp',
    `lowermoldtempRange` = '$arrlowermoldtemp',
    `totallengthRange` = '$arrtotalLength',
    `swabheadlengthRange` = '$arrswabheadlength',
    `swabheadwidthRange` = '$arrswabheadwidth',
    `swabheadthicknessRange` = '$arrswabheadthickness',
    `swabhandlewidthRange` = '$arrswabhandlewidth',
    `swabhandlethicknessRange` = '$arrswabhandlethickness',
    `swabheaddiameterRange` = '$arrswabhandlediameter',
    `swabdimensionspecsRange` = '$substrateDimensionforce',
    `pull/sealstrengthspecsRange` = '$pullSeatTestforce',
    `noofsample` = '$noHandleperHT',
    `pullTest` = '$arrpulltest',
    `pulltestingMin` = '$pulltestingMin',
    `swabheadpullingRange` = '$arrswabheadpulling',
    `swabheadpoppingRange` = '$arrswabheadpopping',
    `pulltestdesc` = '$pulltestdesc',
    `heaterTempUpnLowRange` = '$arrheaterTempUpnLow',
    `heatingTimeRange` = '$arrheatingTime',
    `heaterSwabHandleFixtureRange` = '$arrheaterSwabHandleFixture',
    `fixtureClosingTimeRange` = '$arrfixtureClosingTime',
...
WHERE id = '$checklistId';
  ...
  `workorder`, `date`, `time`, `shift`, `operatorName`, `teamLead`, `machineNo`, `product`, `type`, 
  `InspectedBY`, `maintenancecheced`, `handle`, `substrate`, `handleTreeColor`, `substrateLotNum`, 
  `handleTreeMaterialNum`, `texwipeLogo`, `remarksInprocess`, `productionStats`, `remarksProduction`, 
  `visualInpection`, `remarksVisual`, `resistanceInpection`, `remarksResistance`, `status`, 
  `SampleRange`, `remarksPullTesting`
) VALUES ( 
  '$workorder', '$date', '$time', '$shift', '$operatorName', '$teamLead', '$machineNo', '$product', '$type', 
  '$InspectedBY', '$maintenancecheced', '$handle', '$substrate', '$handleTreeColor', '$substrateLotNum', 
  '$handleTreeMaterialNum', '$texwipeLogo', '$remarksInprocess', '$productionStats', '$remarksProduction', 
  '$visualInpection', '$remarksVisual', '$resistanceInpection', '$remarksResistance', '$status', 
  '$arrSample', '$remarksPullTesting'
);
