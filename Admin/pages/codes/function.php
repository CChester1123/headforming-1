...
WHERE id = '$checklistId';
	...
	{
		$result = mysqli_query($this->dbh, "INSERT INTO `headforming`.`tbl_swabassembly` ( `workorder`, `date`, `time`, `shift`, `operatorName`, `teamLead`, `machineNo`, `product`, `type`, `InspectedBY`, `maintenancecheced`, `handle`, `substrate`, `handleTreeColor`, `substrateLotNum`, `handleTreeMaterialNum`, `texwipeLogo`, `remarksInprocess`, `productionStats`, `remarksProduction`, `visualInpection`, `remarksVisual`, `manualHeadPulling`, `remarksManualHeadPulling`, `pulltestingMin`, `pulltestingSample`, `remarksPullTesting`, `status` ) VALUES ( '$workorder', '$date', '$time', '$shift', '$operatorName', '$teamLead', '$machineNo', '$product', '$type', '$InspectedBY', '$maintenancecheced', '$handle', '$substrate', '$handleTreeColor', '$substrateLotNum', '$handleTreeMaterialNum', '$texwipeLogo', '$remarksInprocess', '$productionStats', '$remarksProduction', '$visualInpection', '$remarksVisual', '$manualHeadPulling', '$remarksManualHeadPulling', '$pulltestingMin', '$arrSample', '$remarksPullTesting', '$status')");
