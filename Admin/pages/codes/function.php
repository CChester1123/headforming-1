...
class admin_creation
{
	...
	public function createProduct($product, $productDesc, $handle, $subtrate, $pulltestdesc, $status, $arrcuttingforce, $arrsealingtime, $arrcuttingspeed, $arrapproachingposition, $arrsealingpositionspeed, $arrsealingposition, $arruppermoldtemp, $arrlowermoldtemp, $arrtotalLength, $arrswabheadlength, $arrswabheadwidth, $arrswabheadthickness, $arrswabhandlewidth, $arrswabhandlethickness, $arrswabhandlediameter, $arrpulltest, $arrswabheadpulling, $arrswabheadpopping, $substrateDimensionforce, $pullSeatTestforce, $pulltestingMin, $noHandleperHT, $handleColor, $substrateLotNum, $handleTreeMaterialNum, $machineTreeMatType, $substrateType, $arrCheckbox, $moldopenspeed, $arrwatertemp, $arrairpressure, $arrupperheatertemp, $arrlowerheatertemp, $arrheaterTempUpnLow, $arrheaterSwabHandleFixture, $arrfixtureClosingTime, $department, $arrheatingTime)
	{
		...
		if ($count_row >= 1) {
			...
			$result = mysqli_query($this->dbh, "INSERT INTO `headforming`.`tbl_products2` ( `productname`, `productDesc`, `status`, `handle`, `substrate`, `handleTreeColor`, `substrateMatLotNum`, `handleTreeMatLotNum`, `handleTreeMatType`, `substrateMatType`, `pulltestingMin`, `cuttingforceRange`, `sealingtimeRange`, `cuttingspeedRange`, `approachingpositionRange`, `sealingpositionspeedRange`, `sealingpositionRange`, `mode`, `moldopenspeedRange`, `watertempRange`, `airpressureRange`, `upperheattempRange`, `lowerheattempRange`, `uppermoldtempRange`, `lowermoldtempRange`, `totallengthRange`, `swabheadlengthRange`, `swabheadwidthRange`, `swabheadthicknessRange`, `swabhandlewidthRange`, `swabhandlethicknessRange`, `swabheaddiameterRange`, `swabdimensionspecsRange`, `pull/sealstrengthspecsRange`, `noofsample`, `pullTest`, `swabheadpullingRange`, `swabheadpoppingRange`, `pulltestdesc`, `heaterTempUpnLowRange`, `heatingTimeRange`, `heaterSwabHandleFixtureRange`, `fixtureClosingTimeRange`, `department`) VALUES ( '$product', '$productDesc', '$status', '$handle', '$subtrate', '$handleColor', '$substrateLotNum', '$handleTreeMaterialNum', '$machineTreeMatType', '$substrateType', '$pulltestingMin', '$arrcuttingforce', '$arrsealingtime', '$arrcuttingspeed', '$arrapproachingposition', '$arrsealingpositionspeed', '$arrsealingposition', '$arrCheckbox', '$moldopenspeed', '$arrwatertemp', '$arrairpressure', '$arrupperheatertemp', '$arrlowerheatertemp', '$arruppermoldtemp', '$arrlowermoldtemp', '$arrtotalLength', '$arrswabheadlength', '$arrswabheadwidth', '$arrswabheadthickness', '$arrswabhandlewidth', '$arrswabhandlethickness', '$arrswabhandlediameter', '$substrateDimensionforce', '$pullSeatTestforce', '$noHandleperHT', '$arrpulltest', '$arrswabheadpulling', '$arrswabheadpopping', '$pulltestdesc', '$arrheaterTempUpnLow', '$arrheatingTime', '$arrheaterSwabHandleFixture', '$arrfixtureClosingTime', '$department');");
			return $result;
		}
	}
