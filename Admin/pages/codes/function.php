...
class admin_creation
{
	...
	public function createProduct($product,$productDesc,$handle,$subtrate,$pulltestdesc,$status,$arrcuttingforce,$arrsealingtime,$arrcuttingspeed,$arrapproachingposition,$arrsealingpositionspeed,$arrsealingposition,$arruppermoldtemp,$arrlowermoldtemp,$arrtotalLength,$arrswabheadlength,$arrswabheadwidth,$arrswabheadthickness,$arrswabhandlewidth,$arrswabhandlethickness,$arrswabhandlediameter,$arrpulltest,$arrswabheadpulling,$arrswabheadpopping,$substrateDimensionforce,$pullSeatTestforce,$noHandleperHT,$handleColor,$substrateLotNum,$handleTreeMaterialNum,$machineTreeMatType,$substrateType, $arrCheckbox, $moldopenspeed, $arrwatertemp, $arrairpressure, $arrupperheatertemp, $arrlowerheatertemp, $arrheaterTempUpnLow, $arrheaterSwabHandleFixture, $arrfixtureClosingTime, $department)
	{
		...
		if ($count_row >= 1) {
			...
			$result = mysqli_query($this->dbh, "INSERT INTO `headforming`.`tbl_products2` ( `productname`, `productDesc`, `status`, `handle`, `substrate`, `handleTreeColor`, `substrateMatLotNum`, `handleTreeMatLotNum`, `handleTreeMatType`, `substrateMatType`, `cuttingforceRange`, `sealingtimeRange`, `cuttingspeedRange`, `approachingpositionRange`, `sealingpositionspeedRange`, `sealingpositionRange`, `mode`, `moldopenspeedRange`, `watertempRange`, `airpressureRange`, `upperheattempRange`, `lowerheattempRange`, `uppermoldtempRange`, `lowermoldtempRange`, `totallengthRange`, `swabheadlengthRange`, `swabheadwidthRange`, `swabheadthicknessRange`, `swabhandlewidthRange`, `swabhandlethicknessRange`, `swabheaddiameterRange`, `swabdimensionspecsRange`, `pull/sealstrengthspecsRange`, `noofsample`, `pullTest`, `swabheadpullingRange`, `swabheadpoppingRange`, `pulltestdesc`, `heaterTempUpnLowRange`, `heaterSwabHandleFixtureRange`, `fixtureClosingTimeRange`, `department`) VALUES ( '$product', '$productDesc', '$status', '$handle', '$subtrate', '$handleColor', '$substrateLotNum', '$handleTreeMaterialNum', '$machineTreeMatType', '$substrateType', '$arrcuttingforce', '$arrsealingtime', '$arrcuttingspeed', '$arrapproachingposition', '$arrsealingpositionspeed', '$arrsealingposition', '$arrCheckbox', '$moldopenspeed', '$arrwatertemp', '$arrairpressure', '$arrupperheatertemp', '$arrlowerheatertemp', '$arruppermoldtemp', '$arrlowermoldtemp', '$arrtotalLength', '$arrswabheadlength', '$arrswabheadwidth', '$arrswabheadthickness', '$arrswabhandlewidth', '$arrswabhandlethickness', '$arrswabhandlediameter', '$substrateDimensionforce', '$pullSeatTestforce', '$noHandleperHT', '$arrpulltest', '$arrswabheadpulling', '$arrswabheadpopping', '$pulltestdesc', '$arrheaterTempUpnLow', '$arrheaterSwabHandleFixture', '$arrfixtureClosingTime', '$department'); ");
			return $result;
		}
	}
	...
	public function editProduct($prod_id, $product,$productDesc,$handle,$subtrate,$pulltestdesc,$status,$arrcuttingforce,$arrsealingtime,$arrcuttingspeed,$arrapproachingposition,$arrsealingpositionspeed,$arrsealingposition,$arruppermoldtemp,$arrlowermoldtemp,$arrtotalLength,$arrswabheadlength,$arrswabheadwidth,$arrswabheadthickness,$arrswabhandlewidth,$arrswabhandlethickness,$arrswabhandlediameter,$arrpulltest,$arrswabheadpulling,$arrswabheadpopping,$substrateDimensionforce,$pullSeatTestforce,$noHandleperHT,$handleColor,$substrateLotNum,$handleTreeMaterialNum,$machineTreeMatType,$substrateType, $arrCheckbox, $moldopenspeed, $arrwatertemp, $arrairpressure, $arrupperheatertemp, $arrlowerheatertemp, $arrheaterTempUpnLow, $arrheaterSwabHandleFixture, $arrfixtureClosingTime, $department)
	{
		...
		$result = mysqli_query($this->dbh, "UPDATE `headforming`.`tbl_products2` SET `productname` = '$product', `productDesc` = '$productDesc', `status` = '$status', `handle` = '$handle', `substrate` = '$subtrate', `handleTreeColor` = '$handleColor', `substrateMatLotNum` = '$substrateLotNum', `handleTreeMatLotNum` = '$handleTreeMaterialNum', `handleTreeMatType` = '$machineTreeMatType', `substrateMatType` = '$substrateType', `cuttingforceRange` = '$arrcuttingforce', `sealingtimeRange` = '$arrsealingtime', `cuttingspeedRange` = '$arrcuttingspeed', `approachingpositionRange` = '$arrapproachingposition', `sealingpositionspeedRange` = '$arrsealingpositionspeed', `sealingpositionRange` = '$arrsealingposition', `mode` = '$arrCheckbox', `moldopenspeedRange` = '$moldopenspeed', `watertempRange` = '$arrwatertemp', `airpressureRange` = '$arrairpressure', `upperheattempRange` = '$arrupperheatertemp', `lowerheattempRange` = '$arrlowerheatertemp', `uppermoldtempRange` = '$arruppermoldtemp', `lowermoldtempRange` = '$arrlowermoldtemp', `totallengthRange` = '$arrtotalLength', `swabheadlengthRange` = '$arrswabheadlength', `swabheadwidthRange` = '$arrswabheadwidth', `swabheadthicknessRange` = '$arrswabheadthickness', `swabhandlewidthRange` = '$arrswabhandlewidth', `swabhandlethicknessRange` = '$arrswabhandlethickness', `swabheaddiameterRange` = '$arrswabhandlediameter', `swabdimensionspecsRange` = '$substrateDimensionforce', `pull/sealstrengthspecsRange` = '$pullSeatTestforce', `noofsample` = '$noHandleperHT', `pullTest` = '$arrpulltest', `swabheadpullingRange` = '$arrswabheadpulling', `swabheadpoppingRange` = '$arrswabheadpopping', `pulltestdesc` = '$pulltestdesc', `heaterTempUpnLowRange` = '$arrheaterTempUpnLow', `heaterSwabHandleFixtureRange` = '$arrheaterSwabHandleFixture', `fixtureClosingTimeRange` = '$arrfixtureClosingTime', `department` = '$department' WHERE id = '$prod_id';");
		return $result;
	}
